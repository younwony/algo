...
public class Q_11651_좌표_정렬하기2 {
    ...
    public static void main(String[] args) throws IOException {
        ...
        for(int i=0; i<N; i++){
            ...
            // 여기 순서만 y를 0번에 x를 1번에 넣어줌
            xy[i][0] = Integer.parseInt(temp_xy[1]);
            xy[i][1] = Integer.parseInt(temp_xy[0]);
        }

        mergeSort(xy);

        for(int i=0; i<xy.length; i++) {
            // x를 1에 y를 0에 넣었으므로 출력 순서만 반대로 하면 완료
